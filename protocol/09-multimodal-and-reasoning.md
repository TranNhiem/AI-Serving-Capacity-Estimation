...
- The serving block's delivered `video_sampling_fps`, `video_max_frames` and `image_longest_edge_px` match what the workload requested, or the disagreement is noted in the report.
