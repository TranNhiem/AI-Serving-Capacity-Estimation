...
|---|---|---|
| **full** | C1–C11 all pass | comparable with any full or partial conforming report, declared fields permitting |
| **partial** | C1–C5 pass; at least one of C6–C11 fails | MAY be published, MUST be labelled partial, comparability caveated by the failed rule |
